# Summon
summon area_effect_cloud ~ ~0.7 ~ {Duration:-1,Age:-2147483648,WaitTime:-2147483648,Tags:["ezcrawl.crawl_entity","ezcrawl.area_effect_cloud","ezcrawl.noID"],Passengers:[{id:"minecraft:shulker",Silent:1b,Invulnerable:1b,DeathLootTable:"empty",NoAI:1b,AbsorptionAmount:1024f,Health:1024f,AttachFace:0b,Color:0b,Tags:["ezcrawl.crawl_entity","ezcrawl.shulker","ezcrawl.noID"],active_effects:[{id:"minecraft:invisibility",amplifier:0,duration:-1,show_particles:0b}],Attributes:[{Name:generic.armor,Base:30},{Name:generic.max_absorption,Base:1024},{Name:generic.max_health,Base:1024}]}]}

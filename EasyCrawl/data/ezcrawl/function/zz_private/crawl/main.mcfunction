...
execute as @e[type=item_display,tag=ezcrawl.vehicle,distance=0..] if score @s ezcrawl.crawlID = @p ezcrawl.crawlID run function ezcrawl:zz_private/crawl/move_to_player

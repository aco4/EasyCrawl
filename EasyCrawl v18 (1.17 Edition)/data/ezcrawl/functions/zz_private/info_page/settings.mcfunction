...
tellraw @s ""
tellraw @s [{"text":"Change what angle you start/stop crawling "},{"text":"[CUSTOMIZE]","color":"green","bold":true,"hoverEvent":{"action":"show_text","contents":[{"text":"/trigger customizeAngles"}]},"clickEvent":{"action":"run_command","value":"/trigger customizeAngles"}}]
tellraw @s ""
